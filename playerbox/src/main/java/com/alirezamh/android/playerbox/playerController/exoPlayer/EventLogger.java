...
/* package */ final class EventLogger implements ExoPlayer.EventListener,
  ...
  public EventLogger(MappingTrackSelector trackSelector, PlayerStatus playerStatus, Player player) {
  ...
  public void onLoadingChanged(boolean isLoading) {
    if(isLoading) playerStatus.sendTask(PlayerStatus.STATUS_BUFFERING);
...
//        playerStatus.sendTask(PlayerStatus.STATUS_PREPARED);
  ...
  public void onTimelineChanged(Timeline timeline, Object manifest) {
    ...
    playerStatus.sendTask(PlayerStatus.STATUS_PREPARED, (int) period.getDurationMs());
  }
